      ...
      "@graph": [
        ...
        // ─── SoftwareApplication ────────────────────────
        {
          ...
          "featureList": [
            ...
            "GEO Score 0-100 : probabilite d'etre cite par ChatGPT, Claude, Perplexity, Google AI Overviews",
            "Audit GEO (Generative Engine Optimization) et AEO (Answer Engine Optimization)",
            "Visibilite LLM multi-modeles (ChatGPT, Perplexity, Gemini, Claude, Google AI Overviews)",
            "Benchmark LLM parallele multi-modeles",
            "Audit E-E-A-T v3 (Experience, Expertise, Authoritativeness, Trustworthiness)",
            "Cocon semantique 3D interactif (Three.js, TF-IDF) avec detection de cannibalisation",
            "Maillage interne automatise (PageRank interne, ancres optimisees, intent Know/Do/Buy)",
            "Score IAS Indice d'Alignement Strategique multi-axes",
            "Audit Strategique GEO v5 scoring multi-axes",
            "Audit Compare benchmark vs 3 concurrents (Concurrence tab)",
            "SERP Benchmark multi-providers (DataForSEO, SerpApi, Serper, Bright Data)",
            "SEA-SEO Bridge : conversion d'opportunites Google Ads en cibles SEO",
            "Conversion Rate Optimizer avec GA4 et heatmaps comportementales",
            "Detection de drop de trafic par ML (regression predictive)",
            "Audit Local Google My Business et GMB Dashboard",
            "Tracking SERP multi-mots-cles (Position Tracking)",
            "Analyse des bots IA (GPTBot, ClaudeBot, PerplexityBot) avec verification rDNS/ASN",
            "Cloudflare AI Shield Wizard (gestion fine des acces bots IA)",
            "Architecte Generatif : code correctif multi-pages",
            "Crawl multi-pages sitemap-first jusqu'a 50 000 pages",
            "Pipeline editoriale 4 etapes (briefing, stratege, redacteur, tonalisateur)",
            "Autopilote Parmenion maintenance predictive ML (2-10 actions/cycle)",
            "Copilot conversationnel (Stratege + Felix) avec memoire vectorielle pgvector",
            "Diagnostic de marche (DataForSEO overview, ranked keywords, backlinks)",
            "Module Marina : audit B2B et outreach LinkedIn automatise",
            "Connexion CMS directe (WordPress, Shopify, Wix, PrestaShop, Drupal, Odoo, Webflow, custom REST)",
            "Extension Chrome Crawlers AI Sidebar",
            "API MCP Server pour integration agents IA externes",
            "Marque blanche pour agences (Pro Agency)",
            "Gestion d'equipe multi-roles (owner, editor, auditor)"
          ],
          "aggregateRating": {
