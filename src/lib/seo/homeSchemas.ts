...
const softwareApplication = {
  ...
  offers: [
    ...
    },
    {
      ...
      priceCurrency: 'EUR',
      description: 'Facturation à l’usage par wallet : Crawlers API (modules SEO/GEO/IA), Marina API (audits en marque blanche), Périclès API (tâches de contenu).',
      availability: 'https://schema.org/InStock',
  ...
  featureList: [
    ...
    'Périclès API : distribution de tâches de contenu à un worker externe (clé prm_live_)',
    'SDK TypeScript officiels @crawlers/sdk et @pericles/sdk',
    ...
    'Autopilote Périclès : maintenance prédictive et publication éditoriale',
