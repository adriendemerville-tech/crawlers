        ...
        <div className="mt-2 mx-auto w-full flex items-center gap-2 sm:gap-3" style={{ maxWidth: 'min(96%, 40rem)' }}>
          <div className="flex-[2] basis-0 min-w-0 relative">
            <Input
              ...
              className="h-12 sm:h-14 rounded-xl pl-3 pr-10 text-base border-4 border-white placeholder:text-sm placeholder:font-light placeholder:text-muted-foreground/50"
