  ...
  return (
    <section className="relative flex min-h-0 sm:min-h-[48vh] items-center justify-center overflow-hidden px-4 sm:px-6 py-6 sm:py-2 sm:pt-2">
      ...
      <div className="relative mx-auto w-full max-w-5xl text-center">
        ...
        <div className="mt-2 mx-auto w-full flex flex-col items-center gap-2 sm:flex-row sm:flex-nowrap sm:items-center sm:gap-3" style={{ maxWidth: 'min(96%, 46rem)' }}>
          ...
          <div className="w-full sm:flex-[1.8] min-w-0 relative rounded-xl p-[2px] bg-gradient-to-b from-gray-300 via-gray-200 to-gray-400 dark:p-0 dark:bg-none">
            <Input
              type="text"
