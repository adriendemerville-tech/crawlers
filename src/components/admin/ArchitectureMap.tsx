...
const domains: Record<string, Domain> = {
  ...
  "AGENTS IA": { color: "#6A4C93", tables: ["agent_cto_directives", "agent_seo_directives", "agent_ux_directives", "agent_supervisor_directives", "agent_ux_logs", "cto_code_proposals", "cto_agent_logs", "seo_agent_logs", "supervisor_logs", "supervisor_cycles", "pericles_decision_log"], functions: ["agent-cto", "agent-seo", "agent-ux", "dispatch-agent-directives", "supervisor-actions", "pericles-orchestrator", "pericles-feedback", "deploy-code-proposal", "rollback-code-proposal", "ingest-agent"] },
      ...
      <svg viewBox={`0 0 ${SVG_W} ${SVG_H}`} className="w-full h-full">
        ...
        {(() => {
          ...
          const orchestrationFns = [
            "pericles-orchestrator", "supervisor-actions", "dispatch-agent-directives",
