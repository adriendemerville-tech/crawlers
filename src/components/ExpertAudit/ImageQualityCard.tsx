      ...
      <CardContent className="space-y-2">
        <div className="grid grid-cols-2 gap-2 text-sm">
          <div className="p-2 rounded-md bg-muted/30">
            ...
            <p className="text-base font-bold text-foreground">{imagesTotal}</p>
          </div>
          <div className="p-2 rounded-md bg-muted/30">
            <p className="text-xs text-muted-foreground">Avec alt text</p>
            <p className={`text-base font-bold ${altOk === imagesTotal ? 'text-emerald-500' : 'text-foreground'}`}>
              {altOk}/{imagesTotal}
            </p>
          </div>
        </div>
