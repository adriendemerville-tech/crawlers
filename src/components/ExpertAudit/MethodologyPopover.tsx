...
const methodologyTexts: Record<string, string> = {
  ...
  lexical_footprint: "L'Empreinte Lexicale mesure le ratio entre jargon corporate vide et terminologie concrète/actionnable. Un score de 100 = contenu très spécifique avec des verbes d'action et des entités nommées. Un score bas indique un contenu générique ('solutions innovantes', 'leader du marché') que les LLM ignorent.",
