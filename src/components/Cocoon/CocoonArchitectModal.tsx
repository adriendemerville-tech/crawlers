              ...
              {generatedCode ? (
                <div className="p-3">
                  ...
                  <pre
                    ...
                    className="text-[10px] leading-relaxed font-mono text-emerald-300/80 bg-black/40 rounded-lg p-3 overflow-x-auto overflow-y-auto whitespace-pre border border-white/5 max-h-[50vh] focus:outline-hidden focus:ring-1 focus:ring-primary/30"
                  >
                    {generatedCode}
                  </pre>
                </div>
