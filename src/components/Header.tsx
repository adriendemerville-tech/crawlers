...
export function Header() {
  ...
  const isHomePage = location.pathname === '/' || location.pathname.startsWith('/landing/') || location.pathname.startsWith('/blog') || location.pathname.startsWith('/guide') || location.pathname.startsWith('/lexique');
