            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  {language === 'fr' ? 'Rapports, correctifs, audit crawl multi-pages & marque blanche — 59€/mois' : language === 'es' ? 'Informes, correcciones, auditoría crawl multi-páginas y marca blanca — 59€/mes' : 'Reports, fixes, multi-page crawl audit & white label — €59/month'}
                </p>
              </div>
            </div>
            <Link
