  ...
  return (
    <Card className="overflow-hidden card-shadow animate-fade-in">
      <div className="p-4">
        ...
        {/* JS-Generated Schema Warning */}
        {factor.isJsGenerated && (
          <div className="mt-3 flex items-start gap-2 rounded-lg bg-orange-500/10 border border-orange-500/30 px-3 py-2">
