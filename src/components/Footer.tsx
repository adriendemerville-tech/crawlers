...
function FooterComponent() {
  ...
  const toolsLinks = [
    ...
    { label: 'Ranking SERPs', href: '/app/ranking-serp', description: t3(language, 'Benchmark de positions SERP multi-providers', 'Multi-provider SERP rank benchmark', 'Benchmark de posiciones SERP multi-proveedores'), isRoute: true },
  ];
    ...
    <>
      ...
      <footer className="border-t border-border bg-card" role="contentinfo">
        <div className="w-full px-4 py-12 sm:px-6">
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-4 xl:grid-cols-5">
