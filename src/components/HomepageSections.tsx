...
/* Inline SVG logos for ChatGPT, Gemini, Claude — no white background */
const ChatGPTSvg = () => (
  <svg viewBox="0 0 24 24" fill="currentColor" className="h-14 w-14 text-foreground">
...
const ClaudeSvg = () => (
  <svg viewBox="0 0 24 24" className="h-14 w-14">
    <path fill="#D97757" d="M14.957 4.386l-6.77 15.228c-.222.498-.078.86.416.86h1.33c.494 0 .936-.362 1.158-.86L17.86 4.386c.222-.499.078-.86-.416-.86h-1.33c-.494 0-.936.361-1.158.86zm-5.48 6.16L6.14 17.774c-.222.499-.078.86.416.86h1.33c.494 0 .936-.361 1.158-.86l3.337-7.228c.222-.498.078-.86-.416-.86h-1.33c-.494 0-.936.362-1.158.86z" />
  </svg>
);
