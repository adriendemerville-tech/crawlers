...
const i18n = {
  fr: {
    momentumTitle: 'En 2028, il y aura autant de recherches via les agents IA que sur Google',
...
// [Screaming Frog, Surfer SEO, Semrush, BotRank, Meteoria, Crawlers.fr]
const competitorMatrix: Record<string, (boolean | 'partial')[]> = {
  audit_technique: [true, false, true, false, false, true],
  score_geo: [false, false, false, false, true, true],
...
const competitors = ['Screaming Frog', 'Surfer SEO', 'Semrush', 'BotRank', 'Meteoria', 'Crawlers.fr'];
    ...
    <section className="py-14 md:py-20">
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <div className="grid grid-cols-3 gap-6 max-w-2xl mx-auto mt-10">
          ...
          <div className="text-center">
            <p className="text-3xl sm:text-4xl font-extrabold text-brand-violet">78</p>
            <p className="text-sm text-muted-foreground mt-1">
