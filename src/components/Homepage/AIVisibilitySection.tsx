  ...
  return (
    <section className="relative flex min-h-0 sm:min-h-[40vh] items-center justify-center overflow-hidden px-4 sm:px-6 py-10 sm:py-12">
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        <div className="absolute -left-60 -top-60 h-[28rem] w-[28rem] rounded-full bg-brand-violet/5 blur-[100px] hidden sm:block" />
        <div className="absolute -bottom-60 -right-60 h-[28rem] w-[28rem] rounded-full bg-brand-violet/5 blur-[100px] hidden sm:block" />
      </div>
