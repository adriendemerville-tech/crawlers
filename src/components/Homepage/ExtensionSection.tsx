...
export function ExtensionSection() {
  ...
  const t = {
    fr: {
      ...
      bullets: ['Audit SEO', 'Audit GEO', 'E-E-A-T', 'Conversion', 'Machine Layer'],
    },
    es: {
      ...
      bullets: ['Auditoría SEO', 'Auditoría GEO', 'E-E-A-T', 'Conversión', 'Machine Layer'],
    },
    en: {
      ...
      bullets: ['SEO Audit', 'GEO Audit', 'E-E-A-T', 'Conversion', 'Machine Layer'],
    },
