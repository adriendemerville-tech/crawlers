...
export const Route = createFileRoute("/meilleurs-outils-seo-geo-2027")({
  head: () =>
    pageHead({
      title: "Meilleurs outils SEO et GEO 2027 : le classement des 13 suites",
      description:
        "SE Ranking, Crawlers.fr, Surfer SEO, ThotSEO, SoRank, Outrank, ChatSEO, Cocolyze, BotSEO, Localo, Semrush, Ahrefs : classement 2027 des outils SEO et GEO, comparatif, prix et analyse détaillée.",
