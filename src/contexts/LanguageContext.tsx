...
const translations: Record<Language, Translations> = {
  fr: {
    hero: {
      ...
      subheadline: {
        crawlers: "Testez votre visibilité en 30 secondes. <span class='font-mono font-thin'><span class='text-violet-400'>&lt;</span><span class='text-violet-500'>Corrigez</span> <span class='text-foreground'>le code</span><span class='text-violet-400'>/&gt;</span></span> de votre site avec notre <strong class='text-foreground'>Audit expert</strong>. Gagnez sur la concurrence.",
