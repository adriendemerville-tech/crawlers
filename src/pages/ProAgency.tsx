            ...
            <div className="grid gap-6 md:grid-cols-3 mb-12">
              ...
              <div className="relative rounded-2xl border-2 border-amber-400/60 bg-gradient-to-b from-amber-950/20 via-card to-card p-8 flex flex-col shadow-lg shadow-amber-500/5">
                ...
                <ul className="space-y-2 text-sm text-muted-foreground mb-8 flex-1">
                  ...
                  <li className="flex items-center gap-2"><CheckCircle2 className="h-4 w-4 text-amber-500 shrink-0" /> {language === 'fr' ? 'Benchmark LLM & Profondeur LLM illimités' : language === 'es' ? 'Benchmark LLM y Profundidad LLM ilimitados' : 'Unlimited LLM Benchmark & Depth'}</li>
              ...
              <div className="relative rounded-2xl border-2 border-emerald-500/40 bg-gradient-to-b from-emerald-950/20 via-card to-card p-8 flex flex-col">
                ...
                <Button
                  ...
                  className="w-full max-w-xs mx-auto bg-gradient-to-r from-emerald-600 to-cyan-600 hover:from-emerald-700 hover:to-cyan-700 text-white font-bold shadow-lg shadow-emerald-500/20 px-8 py-4 text-center justify-center"
                >
