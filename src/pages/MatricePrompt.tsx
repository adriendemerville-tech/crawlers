      ...
      <div className="min-h-screen flex flex-col bg-background">
        ...
        <main className="flex-1 container mx-auto px-4 py-6 max-w-6xl">
          ...
          <div className="flex items-center gap-3 mb-4">
            <input ref={fileInputRef} type="file" <input ref={fileInputRef} type="file" accept=".csv,.xlsx,.xls,.xlsm,.doc,.docx" className="hidden" onChange={handleFileImport} /> className="hidden" onChange={handleFileImport} />
