          ...
          <article className="prose prose-gray dark:prose-invert max-w-none">
            ...
            <section className="mb-8">
              ...
              <div className="bg-muted/50 rounded-lg p-6 space-y-2 text-muted-foreground">
                ...
                <p><strong className="text-foreground">{t3(language, 'Revendeur et Merchant of Record :', 'Reseller and Merchant of Record:', 'Revendedor y Merchant of Record:')}</strong> Paddle.com Market Ltd., Judd House, 18-29 Mora Street, London EC1V 8BT, United Kingdom — {t3(language, 'notre processus de commande est géré par Paddle.com, Merchant of Record de toutes nos commandes ; Paddle traite les demandes de service client liées aux paiements et gère les retours.', 'our order process is conducted by Paddle.com, the Merchant of Record for all our orders; Paddle handles payment-related customer service inquiries and returns.', 'nuestro proceso de pedido es gestionado por Paddle.com, Merchant of Record de todos nuestros pedidos; Paddle atiende las consultas de servicio al cliente relacionadas con los pagos y gestiona las devoluciones.')}</p>
                <p><strong className="text-foreground">{t3(language, 'Prestataire de paiement (circuits résiduels) :', 'Payment provider (residual flows):', 'Proveedor de pagos (circuitos residuales):')}</strong> Stripe Payments Europe Ltd., 1 Grand Canal Street Lower, Dublin 2, Ireland</p>
              </div>
            </section>
            ...
            <p className="text-sm text-muted-foreground mt-12">
              {t3(language, 'Dernière mise à jour : 16 avril 2026', 'Last updated: April 16, 2026', 'Última actualización: 16 de abril de 2026')}
            </p>
          </article>
        </div>
      </main>
