          ...
          <article className="prose prose-gray dark:prose-invert max-w-none">
            ...
            <section className="mb-8">
              ...
              <p className="text-muted-foreground leading-relaxed">
                {t3(language,
                  'Crawlers AI est une plateforme proposant des services d\'audit SEO et GEO, de crawl multi-pages, d\'analyse concurrentielle, de création de contenu IA, de correction automatique de pages, de connexion CMS directe (WordPress, Shopify, Wix, PrestaShop, Drupal, Odoo), de gestion Google My Business, d\'analyse des logs serveur et de maintenance prédictive par machine learning. L\'activité comprend la fourniture de services numériques gratuits et payants via un système de crédits prépayés et deux abonnements mensuels sans engagement : Pro Agency (29€ TTC/mois) et Pro Agency+ (99€ TTC/mois). Les analyses portent exclusivement sur des données publiquement accessibles.',
                  'Crawlers AI is a platform offering SEO and GEO audit services, multi-page crawling, competitive analysis, AI content creation, automatic page correction, direct CMS connection (WordPress, Shopify, Wix, PrestaShop, Drupal, Odoo), Google My Business management, server log analysis and predictive maintenance through machine learning. The activity includes the provision of free and paid digital services via a prepaid credit system and two monthly subscriptions with no commitment: Pro Agency (€29 incl. VAT/month) and Pro Agency+ (€99 incl. VAT/month). Analyses exclusively cover publicly accessible data.',
                  'Crawlers AI es una plataforma que ofrece servicios de auditoría SEO y GEO, crawl multi-páginas, análisis competitivo, creación de contenido IA, corrección automática de páginas, conexión CMS directa (WordPress, Shopify, Wix, PrestaShop, Drupal, Odoo), gestión Google My Business, análisis de logs de servidor y mantenimiento predictivo mediante machine learning. La actividad incluye la prestación de servicios digitales gratuitos y de pago mediante un sistema de créditos prepagados y dos suscripciones mensuales sin compromiso: Pro Agency (29€ IVA incl./mes) y Pro Agency+ (99€ IVA incl./mes). Los análisis se refieren exclusivamente a datos públicamente accesibles.'
                )}
              </p>
            </section>
