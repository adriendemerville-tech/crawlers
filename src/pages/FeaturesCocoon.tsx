...
const i18n = {
  fr: {
    ...
    heroDesc: "Le module Cocoon transforme votre audit sémantique en une visualisation interactive. Chaque page pulse au rythme de son trafic, chaque lien révèle la force de votre maillage.",
  ...
  en: {
    ...
    heroDesc: "The Cocoon module transforms your semantic audit into an interactive visualization. Each page pulses to the rhythm of its traffic, each link reveals the strength of your internal linking.",
