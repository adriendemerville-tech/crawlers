          ...
          <article className="prose prose-gray dark:prose-invert max-w-none">
            ...
            <section id="objet">
              ...
              <ul>
                ...
                <li>Le <strong>module Marina</strong> : pipeline d'audit automatisé générant un rapport SEO & GEO de 15+ pages (audit technique, stratégique, visibilité IA, cocoon sémantique) consommant 30 crédits par rapport. Le rapport est généré dans la langue demandée par l'intégrateur (fr, en, es) ou auto-détectée depuis le site audité ;</li>
            ...
            <section id="abonnement">
              ...
              <ul>
                ...
                <li><strong>Autopilote Périclès</strong> : maintenance prédictive IA (2-10 actions/cycle) ;</li>
