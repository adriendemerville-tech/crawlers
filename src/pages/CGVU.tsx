          ...
          <article className="prose prose-gray dark:prose-invert max-w-none">
            ...
            <section id="objet">
              ...
              <ul>
                ...
                <li>L'<strong>Conversion Optimizer</strong> : audit UX/CRO contextuel par IA, analyse du ton, des CTAs, de la lisibilité, du potentiel de conversion, de l'expérience mobile et de l'utilisation des mots-clés sur chaque page crawlée, calibré sur le contexte business (positionnement, audience, maturité, objectifs). Les suggestions critiques alimentent automatiquement le Workbench Architect ;</li>
