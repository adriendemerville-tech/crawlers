      ...
      <main className="min-h-screen bg-background pt-20">
        <article className="mx-auto max-w-4xl px-4 py-12 sm:px-6 lg:px-8">
          ...
          <section className="mb-14">
            ...
            <p className="mb-4 leading-relaxed text-muted-foreground">
              Crawlers.fr propose une alternative radicalement plus accessible. L'audit expert sur 168 critères est accessible avec une simple inscription gratuite. Les fonctionnalités premium (crawl multi-pages jusqu'à 50 000 URLs, audit comparé face-à-face, rapports Marina en marque blanche) fonctionnent au crédit (0.90€/unité). Le plan Pro Agency à 29€/mois débloque tout en illimité : Cocoon 3D, Content Architect, CMS Direct, Autopilote Périclès, GSC/GA4 intégré, rapport E-E-A-T evidence-based. Le plan Pro Agency+ à 79€/mois ajoute le crawl 50K pages, l'API Marina illimitée et le support prioritaire.
            </p>
            <p className="mb-4 leading-relaxed text-muted-foreground">
