      ...
      <main className="mx-auto max-w-4xl px-4 py-10 md:py-16">
        ...
        <section className="mt-16 pt-10 border-t border-border">
          ...
          <ul className="grid gap-3 sm:grid-cols-2 list-none p-0">
            <li>
              <Link to="/etudes/autopilot-pericles-iktracker" className="flex items-center justify-between rounded-lg border border-border bg-card/40 p-4 hover:border-foreground/40 transition-colors">
