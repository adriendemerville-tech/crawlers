...
const pageContent = {
  fr: {
    title: "Glossaire SEO, GEO, UX & performance web",
    metaTitle: "Glossaire SEO : lexique GEO, UX & performance web | Crawlers.fr",
    metaDescription: "Glossaire SEO et lexique GEO : définitions claires des termes du référencement, de l'IA générative, de l'UX/CRO et de la performance web (LCP, CLS, LLM, E-E-A-T).",
    intro: "Ce glossaire SEO réunit les définitions essentielles du référencement naturel, de l'optimisation pour les moteurs génératifs (GEO), de l'UX/conversion et de la performance web, classées par ordre alphabétique.",
    ...
    downloadPdf: "Télécharger le glossaire PDF",
    pdfTitle: "Glossaire SEO, GEO & performance web",
    pdfSubtitle: "Référence complète pour la France et l'Europe",
    shareTwitter: "Partager sur X",
    shareLinkedIn: "Partager sur LinkedIn",
    shareText: "Le glossaire SEO, GEO & performance web de Crawlers.fr : plus de 70 définitions claires pour maîtriser le référencement et l'IA générative.",
  },
  en: {
    title: "SEO, GEO, UX & web performance glossary",
    metaTitle: "SEO Glossary: GEO, UX & Web Performance Terms | Crawlers.fr",
    metaDescription: "SEO glossary and GEO lexicon: clear definitions of search, generative AI, UX/CRO and web performance terms (LCP, CLS, LLM, E-E-A-T).",
    intro: "This SEO glossary gathers the essential definitions of search engine optimization, generative engine optimization (GEO), UX/conversion and web performance, listed alphabetically.",
    ...
    pdfTitle: "SEO, GEO & web performance glossary",
    pdfSubtitle: "Complete reference for Great Britain and USA",
    shareTwitter: "Share on X",
    shareLinkedIn: "Share on LinkedIn",
    shareText: "The Crawlers.fr SEO, GEO & web performance glossary: over 70 clear definitions to master search and generative AI.",
  },
  es: {
    title: "Glosario SEO, GEO, UX y rendimiento web",
    metaTitle: "Glosario SEO: términos GEO, UX y rendimiento web | Crawlers.fr",
    metaDescription: "Glosario SEO y léxico GEO: definiciones claras de los términos de posicionamiento, IA generativa, UX/CRO y rendimiento web (LCP, CLS, LLM, E-E-A-T).",
    intro: "Este glosario SEO reúne las definiciones esenciales del posicionamiento en buscadores, la optimización para motores generativos (GEO), la UX/conversión y el rendimiento web, por orden alfabético.",
    ...
    pdfTitle: "Glosario SEO, GEO y rendimiento web",
    ...
    shareText: "El glosario SEO, GEO y rendimiento web de Crawlers.fr: más de 70 definiciones claras para dominar el SEO y la IA generativa.",
  },
};
