...
const glossaryTerms: Record<string, GlossaryTerm[]> = {
  fr: [
    ...
    // Crédits & abonnements
    { term: "Crédits Crawlers", definition: "Unité de consommation pour les fonctionnalités avancées (audits stratégiques, génération de code, Content Architect). { term: "Crédits Crawlers", definition: "Unité de consommation pour les fonctionnalités avancées (audits stratégiques, génération de code, Content Architect). 20 crédits offerts aux 1000 premiers inscrits.", category: "technical" },.", category: "technical" },
