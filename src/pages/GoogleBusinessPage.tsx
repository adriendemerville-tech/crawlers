  ...
  const faqItems = [
    ...
    },
    {
      ...
      a: t3(language,
        ...
        'The Google Business module is included in the Pro Agency+ subscription at €99/month. The Pro Agency subscription at €59/month includes all other tools (unlimited audits, crawl, Cocoon, Content Architect, Autopilot). Independent professionals can also use the module per-use via credits.',
