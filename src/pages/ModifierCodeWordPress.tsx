...
const ModifierCodeWordPress = () => {
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 2, name: 'Blog', item: { '@type': 'Thing', '@id': `${SITE_URL}/blog`, name: 'Blog' } },
      { '@type': 'ListItem', position: 3, name: 'Modifier le Code WordPress', item: { '@type': 'Thing', '@id': SEO_META.canonical, name: 'Modifier le Code WordPress' } },
    ],
  };
