        ...
        <section className="border-y border-border bg-gradient-to-r from-violet-50/50 via-muted/30 to-amber-50/50 dark:from-violet-950/10 dark:via-muted/10 dark:to-amber-950/10 py-14 md:py-20">
          <div className="container mx-auto max-w-3xl px-4 text-center">
            <h2 className="text-2xl font-bold tracking-tight text-foreground sm:text-3xl">
              {language === 'fr' ? <>Observatoire SEO & GEO :<br />statistiques en temps réel du web français</> : language === 'es' ? <>Observatorio SEO & GEO:<br />estadísticas en tiempo real de la web francesa</> : <>SEO & GEO Observatory:<br />real-time French web statistics</>}
            </h2>
