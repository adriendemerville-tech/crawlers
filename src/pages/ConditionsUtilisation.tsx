          ...
          <article className="prose prose-gray dark:prose-invert max-w-none">
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc pl-6 text-muted-foreground space-y-2">
                ...
                <li><strong>{t3(language, 'Abonnement Pro Agency :', 'Pro Agency Subscription:', 'Suscripción Pro Agency:')}</strong> {t3(language, '59€/mois sans engagement – audits experts et codes correctifs illimités, console multi-comptes, marque blanche, support prioritaire, crawl multi-pages (Fair Use : 5 000 pages/mois), Content Architect (100/mois), Autopilote Parménion, connexion CMS directe, GSC/GA4, GMB', '€59/month no commitment – unlimited expert audits and corrective codes, multi-account console, white label, priority support, multi-page crawl (Fair Use: 5,000 pages/month), Content Architect (100/month), Autopilot Parmenion, direct CMS connection, GSC/GA4, GMB', '59€/mes sin compromiso – auditorías expertas y códigos correctivos ilimitados, consola multi-cuentas, marca blanca, soporte prioritario, crawl multi-páginas (Fair Use: 5.000 páginas/mes), Content Architect (100/mes), Autopiloto Parménion, conexión CMS directa, GSC/GA4, GMB')}</li>
                <li><strong>{t3(language, 'Abonnement Pro Agency+ :', 'Pro Agency+ Subscription:', 'Suscripción Pro Agency+:')}</strong> {t3(language, '89€/mois sans engagement – tout Pro Agency + 100 000 pages crawl/mois, 5 comptes, Content Architect (200/mois), support prioritaire renforcé', '€89/month no commitment – everything in Pro Agency + 100,000 crawl pages/month, 5 accounts, Content Architect (200/month), enhanced priority support', '89€/mes sin compromiso – todo Pro Agency + 100.000 páginas crawl/mes, 5 cuentas, Content Architect (200/mes), soporte prioritario reforzado')}</li>
              </ul>
            </section>
            ...
            <section className="mb-8">
              ...
              <div className="bg-muted/50 rounded-lg p-6 mb-4">
                <h3 className="font-semibold text-foreground mb-3">{t3(language, 'Abonnement Pro Agency+ :', 'Pro Agency+ Subscription:', 'Suscripción Pro Agency+:')}</h3>
                <ul className="text-muted-foreground space-y-1">
                  <li>• {t3(language, '89€ TTC / mois, sans engagement, résiliable à tout moment', '€89 incl. VAT / month, no commitment, cancellable at any time', '89€ IVA incl. / mes, sin compromiso, cancelable en cualquier momento')}</li>
                  <li>• {t3(language, 'Tout Pro Agency + 100 000 pages crawl/mois, 5 comptes, Content Architect (200/mois), support prioritaire renforcé', 'Everything in Pro Agency + 100,000 crawl pages/month, 5 accounts, Content Architect (200/month), enhanced priority support', 'Todo Pro Agency + 100.000 páginas crawl/mes, 5 cuentas, Content Architect (200/mes), soporte prioritario reforzado')}</li>
                </ul>
              </div>
              <div className="bg-muted/50 rounded-lg p-6 mb-4">
