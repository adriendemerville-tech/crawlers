          ...
          <article className="prose prose-gray dark:prose-invert max-w-none">
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc pl-6 text-muted-foreground space-y-2">
                ...
                <li><strong>{t3(language, 'Abonnement Pro Agency+ :', 'Pro Agency+ Subscription:', 'Suscripción Pro Agency+:')}</strong> {t3(language, '99€/mois sans engagement – tout Pro Agency + 100 000 pages crawl/mois, 5 comptes, Content Architect (150/mois), API Marina en marque blanche complète, analyse des logs, support prioritaire renforcé', '€99/month no commitment – everything in Pro Agency + 100,000 crawl pages/month, 5 accounts, Content Architect (150/month), Marina API with full white label, log analysis, enhanced priority support', '99€/mes sin compromiso – todo Pro Agency + 100.000 páginas crawl/mes, 5 cuentas, Content Architect (150/mes), API Marina con marca blanca completa, análisis de logs, soporte prioritario reforzado')}</li>
              </ul>
            </section>
