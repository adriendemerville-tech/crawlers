          ...
          <article className="prose prose-gray dark:prose-invert max-w-none">
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc pl-6 text-muted-foreground space-y-2">
                ...
                <li><strong>{t3(language, 'Abonnement Pro Agency :', 'Pro Agency Subscription:', 'Suscripción Pro Agency:')}</strong> {t3(language, '29€/mois sans engagement – audits experts et codes correctifs illimités, console multi-comptes, marque blanche + 2 comptes, support prioritaire, crawl multi-pages (Fair Use : 5 000 pages/mois, 10 pages par scan), Autopilote Parménion, connexion CMS directe, GSC/GA4, GMB', '€29/month no commitment – unlimited expert audits and corrective codes, multi-account console, white label + 2 accounts, priority support, multi-page crawl (Fair Use: 5,000 pages/month, 10 pages per scan), Autopilot Parmenion, direct CMS connection, GSC/GA4, GMB', '29€/mes sin compromiso – auditorías expertas y códigos correctivos ilimitados, consola multi-cuentas, marca blanca + 2 cuentas, soporte prioritario, crawl multi-páginas (Fair Use: 5.000 páginas/mes, 10 páginas por escaneo), Autopiloto Parménion, conexión CMS directa, GSC/GA4, GMB')}</li>
                <li><strong>{t3(language, 'Abonnement Pro Agency+ :', 'Pro Agency+ Subscription:', 'Suscripción Pro Agency+:')}</strong> {t3(language, '79€/mois sans engagement – tout Pro Agency + 50 000 pages crawl/mois (50 pages par scan), 3 comptes, Benchmark LLM & Profondeur LLM illimités, API Marina, analyse des logs, stratégie concurrentielle, protocole auth SSO SAML, support prioritaire renforcé', '€79/month no commitment – everything in Pro Agency + 50,000 crawl pages/month (50 pages per scan), 3 accounts, unlimited LLM Benchmark & Depth, Marina API, log analysis, competitive strategy, SSO SAML authentication, enhanced priority support', '79€/mes sin compromiso – todo Pro Agency + 50.000 páginas crawl/mes (50 páginas por escaneo), 3 cuentas, Benchmark LLM y Profundidad LLM ilimitados, API Marina, análisis de logs, estrategia competitiva, protocolo auth SSO SAML, soporte prioritario reforzado')}</li>
              </ul>
            </section>
            ...
            <section className="mb-8">
              ...
              <div className="bg-muted/50 rounded-lg p-6 mb-4">
                ...
                <ul className="text-muted-foreground space-y-1">
                  ...
                  <li>• <strong>{t3(language, 'Pack Ultime : 500 crédits = 79€ TTC', 'Ultimate Pack: 500 credits = €79 incl. VAT', 'Pack Último: 500 créditos = 79€ IVA incl.')}</strong></li>
                </ul>
              </div>
              <div className="bg-muted/50 rounded-lg p-6 mb-4">
                ...
                <ul className="text-muted-foreground space-y-1">
                  <li>• {t3(language, '29€ TTC / mois, sans engagement', '€29 incl. VAT / month, no commitment', '29€ IVA incl. / mes, sin compromiso')}</li>
                  <li>• {t3(language, 'Inclut : audits illimités, codes correctifs illimités, console multi-comptes, marque blanche + 2 comptes, Autopilote Parménion, connexion CMS directe, GSC/GA4, GMB', 'Includes: unlimited audits, unlimited corrective codes, multi-account console, white label + 2 accounts, Autopilot Parmenion, direct CMS connection, GSC/GA4, GMB', 'Incluye: auditorías ilimitadas, códigos correctivos ilimitados, consola multi-cuentas, marca blanca + 2 cuentas, Autopiloto Parménion, conexión CMS directa, GSC/GA4, GMB')}</li>
                  <li>• {t3(language, 'Crawl multi-pages : Fair Use Policy de 5 000 pages/mois (10 pages par scan)', 'Multi-page crawl: Fair Use Policy of 5,000 pages/month (10 pages per scan)', 'Crawl multi-páginas: Fair Use Policy de 5.000 páginas/mes (10 páginas por escaneo)')}</li>
                </ul>
              </div>
              <div className="bg-muted/50 rounded-lg p-6 mb-4">
                <h3 className="font-semibold text-foreground mb-3">{t3(language, 'Abonnement Pro Agency+ :', 'Pro Agency+ Subscription:', 'Suscripción Pro Agency+:')}</h3>
                <ul className="text-muted-foreground space-y-1">
                  <li>• {t3(language, '79€ TTC / mois, sans engagement', '€79 incl. VAT / month, no commitment', '79€ IVA incl. / mes, sin compromiso')}</li>
                  <li>• {t3(language, 'Tout Pro Agency + 50 000 pages crawl/mois (50 pages par scan), 3 comptes, Benchmark LLM & Profondeur LLM illimités, API Marina, analyse des logs, stratégie concurrentielle, protocole auth SSO SAML, support prioritaire renforcé', 'Everything in Pro Agency + 50,000 crawl pages/month (50 pages per scan), 3 accounts, unlimited LLM Benchmark & Depth, Marina API, log analysis, competitive strategy, SSO SAML authentication, enhanced priority support', 'Todo Pro Agency + 50.000 páginas crawl/mes (50 páginas por escaneo), 3 cuentas, Benchmark LLM y Profundidad LLM ilimitados, API Marina, análisis de logs, estrategia competitiva, protocolo auth SSO SAML, soporte prioritario reforzado')}</li>
                </ul>
              </div>
              <div className="bg-muted/50 rounded-lg p-6 mb-4">
