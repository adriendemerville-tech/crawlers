          ...
          <article className="prose prose-gray dark:prose-invert max-w-none">
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc pl-6 text-muted-foreground space-y-2">
                ...
                <li><strong>{t3(language, 'Abonnement Pro Agency :', 'Pro Agency Subscription:', 'Suscripción Pro Agency:')}</strong> {t3(language, '29€/mois sans engagement – audits experts et codes correctifs illimités, console multi-comptes, marque blanche + 2 comptes, support prioritaire, crawl multi-pages (Fair Use : 5 000 pages/mois, 10 pages par scan), Autopilote Périclès, connexion CMS directe, GSC/GA4, GMB', '€29/month no commitment – unlimited expert audits and corrective codes, multi-account console, white label + 2 accounts, priority support, multi-page crawl (Fair Use: 5,000 pages/month, 10 pages per scan), Autopilot Pericles, direct CMS connection, GSC/GA4, GMB', '29€/mes sin compromiso – auditorías expertas y códigos correctivos ilimitados, consola multi-cuentas, marca blanca + 2 cuentas, soporte prioritario, crawl multi-páginas (Fair Use: 5.000 páginas/mes, 10 páginas por escaneo), Autopiloto Périclès, conexión CMS directa, GSC/GA4, GMB')}</li>
            ...
            <section className="mb-8">
              ...
              <div className="bg-muted/50 rounded-lg p-6 mb-4">
                ...
                <ul className="text-muted-foreground space-y-1">
                  ...
                  <li>• {t3(language, 'Inclut : audits illimités, codes correctifs illimités, console multi-comptes, marque blanche + 2 comptes, Autopilote Périclès, connexion CMS directe, GSC/GA4, GMB', 'Includes: unlimited audits, unlimited corrective codes, multi-account console, white label + 2 accounts, Autopilot Pericles, direct CMS connection, GSC/GA4, GMB', 'Incluye: auditorías ilimitadas, códigos correctivos ilimitados, consola multi-cuentas, marca blanca + 2 cuentas, Autopiloto Périclès, conexión CMS directa, GSC/GA4, GMB')}</li>
