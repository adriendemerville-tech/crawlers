        ...
        <div className="container mx-auto max-w-4xl px-4">
          ...
          <article className="prose prose-gray dark:prose-invert max-w-none">
            ...
            <section className="mb-8">
              ...
              <ul className="list-disc pl-6 text-muted-foreground space-y-2 mb-4">
                <li>{t3(language, 'Les paiements sont traités par Paddle.com Market Ltd., Merchant of Record de nos commandes, et par Stripe Payments Europe Ltd. (Dublin, Irlande) pour les circuits résiduels. Nous ne stockons jamais vos données bancaires.', 'Payments are processed by Paddle.com Market Ltd., the Merchant of Record for our orders, and by Stripe Payments Europe Ltd. (Dublin, Ireland) for residual flows. We never store your banking data.', 'Los pagos son procesados por Paddle.com Market Ltd., Merchant of Record de nuestros pedidos, y por Stripe Payments Europe Ltd. (Dublín, Irlanda) para circuitos residuales. Nunca almacenamos sus datos bancarios.')}</li>
                <li>{t3(language, 'Seules les informations de transaction (montant, date, identifiant de transaction Paddle ou Stripe, type d\'achat) sont conservées.', 'Only transaction information (amount, date, Paddle or Stripe transaction identifier, purchase type) is retained.', 'Solo se conserva la información de la transacción (monto, fecha, identificador de transacción Paddle o Stripe, tipo de compra).')}</li>
              </ul>
            ...
            <section className="mb-8">
              ...
              <div className="bg-muted/50 rounded-lg p-6 space-y-4">
                <div>
                  <p className="font-medium text-foreground">Paddle.com Market Ltd.</p>
                  <p className="text-sm text-muted-foreground">{t3(language, 'Merchant of Record : vente du produit, gestion des abonnements, paiements, conformité fiscale (TVA) et facturation. Données transmises : email, montant, devise, pays de facturation.', 'Merchant of Record: sale of the product, subscription management, payments, tax (VAT) compliance and invoicing. Data transmitted: email, amount, currency, billing country.', 'Merchant of Record: venta del producto, gestión de suscripciones, pagos, cumplimiento fiscal (IVA) y facturación. Datos transmitidos: email, monto, divisa, país de facturación.')}</p>
                  <a href="https://www.paddle.com/legal/privacy" target="_blank" rel="noopener noreferrer" className="text-sm text-primary hover:underline">
                    {t3(language, 'Politique de confidentialité Paddle', 'Paddle Privacy Policy', 'Política de privacidad de Paddle')}
                  </a>
                </div>
                <div>
                  <p className="font-medium text-foreground">Stripe Payments Europe Ltd.</p>
                  <p className="text-sm text-muted-foreground">{t3(language, 'Traitement des paiements pour les circuits résiduels. Données transmises : email, montant, devise. Certifié PCI-DSS niveau 1.', 'Payment processing for residual flows. Data transmitted: email, amount, currency. PCI-DSS Level 1 certified.', 'Procesamiento de pagos para circuitos residuales. Datos transmitidos: email, monto, divisa. Certificado PCI-DSS nivel 1.')}</p>
