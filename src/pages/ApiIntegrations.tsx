...
const apis: ApiCard[] = [
  {
    ...
    interactsWith: ['Toutes les fonctionnalités Crawlers (hors Marina & Périclès qui ont leur API dédiée)'],
    disconnectable: true,
  ...
  },
  {
    ...
    interactsWith: ['Audit Stratégique IA', 'IAS', 'Prédictions de trafic', 'Anomaly Detection', 'Autopilote Périclès'],
    disconnectable: true,
  ...
  },
  {
    ...
    interactsWith: ['Code Architect', 'Cocoon Auto-Linking', 'Autopilote Périclès', 'Content Architect'],
    disconnectable: true,
  ...
  },
  {
    ...
    interactsWith: ['Code Architect', 'Audit Stratégique IA', 'Autopilote Périclès'],
    disconnectable: true,
  ...
  },
  {
    ...
    purpose: 'API REST en mode pull : votre site interroge Périclès pour récupérer les tâches de contenu SEO planifiées, les publie sur votre CMS interne, puis confirme. Aucun accès sortant requis depuis Crawlers. Documentation complète : /docs/api/pericles',
    dataUsage: [
    ...
    interactsWith: ['Autopilote Périclès', 'Content Architect', 'GSC / GA4 measurement'],
    disconnectable: true,
